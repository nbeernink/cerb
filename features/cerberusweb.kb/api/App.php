...
class ChKbPage extends CerberusPageExtension
{
    ...
    public function viewKbArticlesExploreAction()
    {
...
class WorkspaceTab_KbBrowse extends Extension_WorkspaceTab
{
    ...
    public function importTabConfigJson($json, Model_WorkspaceTab $tab)
    {
...
class ChKbAjaxController extends DevblocksControllerExtension
{
    ...
    public function showArticleEditPanelAction()
    {
        $active_worker = CerberusApplication::getActiveWorker();
    ...
    public function saveArticleEditPanelAction()
    {
        $active_worker = CerberusApplication::getActiveWorker();
        if (!$active_worker->hasPriv('core.kb.articles.modify')) {
            return;
    ...
    public function showKbCategoryEditPanelAction()
    {
        $active_worker = CerberusApplication::getActiveWorker();
    ...
    public function saveKbCategoryEditPanelJsonAction()
    {
    ...
    public function getArticleContentAction()
    {
        @$id = DevblocksPlatform::importGPC($_REQUEST['id'], 'integer', 0);
...
class DAO_KbCategory extends Cerb_ORMHelper
{
    ...
    public static function getTreeMap($prune_empty=false)
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    private static function _recurseTree(&$levels, $map, $node=0, $level=-1)
    {
    ...
    public static function getAncestors($root_id, $categories=null)
    {
        if (empty($categories)) {
            $categories = DAO_KbCategory::getAll();
        }
    ...
    public static function getDescendents($root_id)
    {
     ...
     * @return Model_KbCategory[]
     */
    public static function getWhere($where=null, $sortBy=DAO_KbCategory::NAME, $sortAsc=true, $limit=null, $options=null)
    {
        $db = DevblocksPlatform::getDatabaseService();
...
class Context_KbCategory extends Extension_DevblocksContext
{
    ...
    public function getContext($category, &$token_labels, &$token_values, $prefix=null)
    {
        if (is_null($prefix)) {
            $prefix = 'Category:';
        }
