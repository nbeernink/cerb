...
class Ch_RestPreferencesTab extends Extension_PreferenceTab
{
    ...
    public function showPeekPopupAction()
    {
    ...
    public function savePeekPopupAction()
    {
        @$id = DevblocksPlatform::importGPC($_REQUEST['id'], 'integer', 0);
...
interface IExtensionRestController
{
    ...
    public function search($filters=array(), $sortToken='', $sortAsc=1, $page=1, $limit=10, $options=array());
    public function translateToken($token, $type='dao');
};
