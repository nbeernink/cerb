...
class ChTimeTrackingPage extends CerberusPageExtension
{
    ...
    public function startTimerAction()
    {
    ...
    public function pauseTimerJsonAction()
    {
    ...
    public function viewMarkClosedAction()
    {
        @$view_id = DevblocksPlatform::importGPC($_REQUEST['view_id'], 'string');
    ...
    public function viewTimeExploreAction()
    {
        @$view_id = DevblocksPlatform::importGPC($_REQUEST['view_id'], 'string');
...
//					'toolbar_extension_id' => 'cerberusweb.explorer.toolbar.',
    ...
    public function clearEntryAction()
    {
        $this->_destroyTimer();
    }
};
