...
class ChTranslators_SetupPageSection extends Extension_PageSection
{
    ...
    public function showFindStringsPanelAction($model=null)
    {
        $tpl = DevblocksPlatform::getTemplateService();
    ...
    public function saveFindStringsPanelAction()
    {
    ...
    public function showAddLanguagePanelAction($model=null)
    {
        $tpl = DevblocksPlatform::getTemplateService();
    ...
    public function saveAddLanguagePanelAction()
    {
        $active_worker = CerberusApplication::getActiveWorker();
    ...
    public function showImportStringsPanelAction($model=null)
    {
        $tpl = DevblocksPlatform::getTemplateService();
        $tpl->display('devblocks:cerberusweb.translators::config/ajax/import_strings_panel.tpl');
    }

    public function saveImportStringsPanelAction()
    {
    ...
    public function exportTmxAction()
    {
        $defaults = C4_AbstractViewModel::loadFromClass('View_Translation');
        $defaults->id = View_Translation::DEFAULT_ID;
