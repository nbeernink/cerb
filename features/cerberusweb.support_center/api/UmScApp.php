...
class UmScLoginAuthenticator extends Extension_ScLoginAuthenticator
{
    ...
    public function doRegisterConfirmAction()
    {
...
class UmScAbstractViewLoader
{
     ...
     * @return boolean
     */
    public static function exists($view_label)
    {
     ...
     */
    public static function getView($class, $view_label)
    {
        if (is_null(self::$views)) {
            self::_init();
        }
     ...
     */
    public static function setView($view_label, $view)
    {
        if (is_null(self::$views)) {
            self::_init();
        }
    ...
    public static function deleteView($view_label)
    {
    ...
    public static function serializeAbstractView($view)
    {
    ...
    public static function unserializeAbstractView(C4_AbstractViewModel $model)
    {
