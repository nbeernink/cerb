...
class DAO_FeedbackEntry extends Cerb_ORMHelper
{
     ...
     * @return boolean
     */
    public static function bulkUpdate(Model_ContextBulkUpdate $update)
    {
...
class View_FeedbackEntry extends C4_AbstractView implements IAbstractView_Subtotals, IAbstractView_QuickSearch
{
    ...
    public function getDataAsObjects($ids=null)
    {
        return $this->_getDataAsObjects('DAO_FeedbackEntry', $ids);
    }
    
    public function getDataSample($size)
    {
    ...
    public function getSubtotalCounts($column)
    {
        $counts = array();
    ...
    public function getParamFromQuickSearchFieldTokens($field, $tokens)
    {
        switch ($field) {
            case 'mood':
    ...
    public function renderCriteria($field)
    {
        $tpl = DevblocksPlatform::getTemplateService();
        $tpl->assign('id', $this->id);
        $tpl->assign('view', $this);
    ...
    public function renderVirtualCriteria($param)
    {
        $key = $param->field;
    ...
    public function renderCriteriaParam($param)
    {
        $field = $param->field;
    ...
    public function doSetCriteria($field, $oper, $value)
    {
        $criteria = null;
...
class ChFeedbackController extends DevblocksControllerExtension
{
    ...
    public function showBulkPanelAction()
    {
    ...
    public function startBulkUpdateJsonAction()
    {
...
class Context_Feedback extends Extension_DevblocksContext implements IDevblocksContextPeek
{
    ...
    public static function searchInboundLinks($from_context, $from_context_id)
    {
    ...
    public function getPropertyLabels(DevblocksDictionaryDelegate $dict)
    {
        $labels = $dict->_labels;
    ...
    public function getContext($feedback, &$token_labels, &$token_values, $prefix=null)
    {
        if (is_null($prefix)) {
            $prefix = 'Feedback:';
        }
