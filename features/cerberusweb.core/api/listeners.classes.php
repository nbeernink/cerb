...
{
    public function run(DevblocksHttpResponse $response, Smarty $tpl)
    {
        $path = $response->path;
...
{
    public static $_traversal_log = array();
    public static $_trigger_log = array();
    public static $_trigger_stack = array();
    public static $_depth = 0;
    
    public static function increaseDepth($trigger_id)
    {
        ++self::$_depth;
     ...
     */
    public static function inception($trigger_id)
    {
        return in_array($trigger_id, self::$_trigger_stack);
    }
    
    public static function triggerHasSprung($trigger_id)
    {
        return in_array($trigger_id, self::$_trigger_log);
    }
    
    public static function logNode($node_id)
    {
    ...
    public static function getTriggerStack()
    {
        return self::$_trigger_stack;
    }
    
    public static function getTriggerLog()
    {
        return self::$_trigger_log;
    }
    
    public static function getNodeLog()
    {
...
class ChCoreEventListener extends DevblocksEventListenerExtension
{
    ...
    private function _handleCommentCreate($event)
    { /* @var $event Model_DevblocksEvent */
