...
abstract class Extension_CalendarDatasource extends DevblocksExtension
{
    ...
    abstract public function getData(Model_Calendar $calendar, array $params=array(), $params_prefix=null, $date_range_from, $date_range_to);
};
...
abstract class Extension_WorkspaceWidgetDatasource extends DevblocksExtension
{
    ...
    abstract public function renderConfig(Model_WorkspaceWidget $widget, $params=array(), $params_prefix=null);
    abstract public function getData(Model_WorkspaceWidget $widget, array $params=array(), $params_prefix=null);
};
