...
class CerberusMail
{
    ...
    public static function quickSend($to, $subject, $body, $from_addy=null, $from_personal=null, $custom_headers=array(), $format=null, $html_template_id=null, $file_ids=array())
    {
        try {
    ...
    public static function sendTicketMessage($properties=array())
    {
        $settings = DevblocksPlatform::getPluginSettingsService();
