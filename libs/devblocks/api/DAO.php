...
abstract class DevblocksORMHelper
{
    ...
    protected static function _buildSortClause($sortBy, $sortAsc, $fields, &$select_sql, $search_class=null)
    {
        $sort_sql = null;
    ...
    protected static function _getWhereSQL($where=null, $sortBy=null, $sortAsc=true, $limit=null)
    {
        // Where
     ...
     * @param array $fields
     */
    protected static function _insert($table, $fields, $idcol='id')
    {
     ...
     * @param array $fields
     */
    protected static function _update($ids=array(), $table, $fields, $idcol='id', $option_bits = 0)
    {
        if (!is_array($ids)) {
            $ids = array($ids);
        }
    ...
    protected static function _updateWhere($table, $fields, $where)
    {
        $db = DevblocksPlatform::getDatabaseService();
        $sets = array();
    ...
    protected static function _parseSearchParams($params, $columns=array(), $search_class, $sortBy='')
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    private static function _parseNestedSearchParams($param, &$tables, $search_class, $pkey=null)
    {
        $pkey = $search_class::getPrimaryKey();
        $fields = $search_class::getFields();
...
{
    public static function cleanupPluginTables()
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    public static function updatePlugin($id, $fields)
    {
        $db = DevblocksPlatform::getDatabaseService();
        $prefix = (APP_DB_PREFIX != '') ? APP_DB_PREFIX.'_' : ''; // [TODO] Cleanup
        $sets = array();
    ...
    public static function deleteExtension($extension_id)
    {
        $db = DevblocksPlatform::getDatabaseService();
        $prefix = (APP_DB_PREFIX != '') ? APP_DB_PREFIX.'_' : ''; // [TODO] Cleanup
     ...
     * @return boolean
     */
    public static function hasPatchRun($plugin_id, $revision)
    {
     ...
     * @param integer $revision
     */
    public static function setPatchRan($plugin_id, $revision)
    {
        $db = DevblocksPlatform::getDatabaseService();
        $prefix = (APP_DB_PREFIX != '') ? APP_DB_PREFIX.'_' : ''; // [TODO] Cleanup
    ...
    public static function getClassLoaderMap()
    {
...
{
    public static function set($plugin_id, $key, $value)
    {
    ...
    public static function getSettings($plugin_id)
    {
        $tables = DevblocksPlatform::getDatabaseTables();
...
class DAO_DevblocksExtensionPropertyStore extends DevblocksORMHelper
{
    ...
    private static function _getCacheKey($extension_id)
    {
    ...
    public static function getByExtension($extension_id)
    {
        $cache = DevblocksPlatform::getCacheService();
    ...
    public static function get($extension_id, $key, $default=null)
    {
        $params = self::getByExtension($extension_id);
        return isset($params[$key]) ? $params[$key] : $default;
    }
    
    public static function put($extension_id, $key, $value)
    {
        $db = DevblocksPlatform::getDatabaseService();
        $prefix = (APP_DB_PREFIX != '') ? APP_DB_PREFIX.'_' : ''; // [TODO] Cleanup
        $cache_key = self::_getCacheKey($extension_id);
...
class DAO_Translation extends DevblocksORMHelper
{
    ...
    public static function importTmxFile($filename)
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    public static function reloadPluginStrings()
    {
        $plugins = DevblocksPlatform::getPluginRegistry();
    ...
    public static function getByLang($lang='en_US')
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    public static function getMapByLang($lang='en_US')
    {
    ...
    public static function getString($string_id, $lang='en_US')
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    public static function deleteByLangCodes($codes)
    {
        if (!is_array($codes)) {
            $codes = array($codes);
        }
     ...
     * @return array
     */
    public static function search($columns, $params, $limit=10, $page=0, $sortBy=null, $sortAsc=null, $withCounts=true)
    {
        $db = DevblocksPlatform::getDatabaseService();
...
class SearchFields_Translation extends DevblocksSearchFields
{
    ...
    public static function getCustomFieldContextKeys()
    {
        return array(
    ...
    public static function getWhereSQL(DevblocksSearchCriteria $param)
    {
...
{
    public static function getPendingProfiles()
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    public static function getKeys($storage_namespace, $storage_extension, $storage_profile_id=0, $limit=500)
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    public static function enqueueDelete($storage_namespace, $storage_key, $storage_extension, $storage_profile_id=0)
    {
        $db = DevblocksPlatform::getDatabaseService();
    ...
    public static function purgeKeys($keys, $storage_namespace, $storage_extension, $storage_profile_id=0)
    {
        $db = DevblocksPlatform::getDatabaseService();
