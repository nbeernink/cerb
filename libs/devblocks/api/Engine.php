...
abstract class DevblocksEngine
{
    ...
    protected static $extensionDelegate = null;
    protected static $handlerSession = null;

    protected static $start_time = 0;
    protected static $start_memory = 0;
    protected static $start_peak_memory = 0;

    protected static $timezone = '';
    protected static $locale = 'en_US';
    protected static $dateTimeFormat = 'D, d M Y h:i a';

    protected static $_tmp_files = array();
     ...
     */
    protected static function _readPluginManifest($plugin_path, $is_update=true)
    {
        /*
    ...
    public static function readRequest()
    {
        ...
        if (empty($parts)) {
            ...
            if (!empty($uri)) {
                $parts[] = DevblocksPlatform::strAlphaNum($uri, '\_\-\.');
            }
            ...
            if (!empty($listener)) {
                $parts[] = DevblocksPlatform::strAlphaNum($listener, '\_');
            }
        }
