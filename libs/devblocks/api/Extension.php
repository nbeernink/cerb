...
class Exception_DevblocksAjaxValidationError extends Exception_Devblocks
{
    ...
    public function __construct($message=null, $field_name=null)
    {
...
{
    public function renderPeekPopup($context_id=0, $view_id='', $edit=false);
}

interface IDevblocksContextImport
{
    public function importGetKeys();
    public function importKeyValue($key, $value);
    public function importSaveObject(array $fields, array $custom_fields, array $meta);
}
...
{
    public static $_changed_contexts = array();
    ...
    public static function shutdownTriggerChangedContextsEvents()
    {
    ...
    public static function getAliasesForContext(DevblocksExtensionManifest $ctx_manifest)
    {
        ...
        if (is_array($names) && !empty($names)) {
            foreach ($names as $name => $meta) {
                ...
                } elseif ($is_plural && !$is_short && empty($results['plural'])) {
                    $results['plural'] = $name;
                } elseif (!$is_plural && $is_short && empty($results['singular_short'])) {
                    $results['singular_short'] = $name;
                } elseif ($is_plural && $is_short && empty($results['plural_short'])) {
    ...
    public static function getPlaceholderTree($labels)
    {
        $keys = array();
    ...
    abstract public function getRandom();
    abstract public function getMeta($context_id);
    abstract public function getContext($object, &$token_labels, &$token_values, $prefix=null);
     ...
     * @return array
     */
    public function getCardProperties()
    {
    ...
    public function getModelObjects(array $ids)
    {
    ...
    abstract public function getChooserView($view_id=null);
    abstract public function getView($context=null, $context_id=null, $options=array(), $view_id=null);
    ...
    public static function getTimelineComments($context, $context_id, $is_ascending=true)
    {
        $timeline = array();
...
abstract class Extension_DevblocksEvent extends DevblocksExtension
{
    ...
    abstract public function setEvent(Model_DevblocksEvent $event_model=null, Model_TriggerEvent $trigger);
    ...
    public function getLabels(Model_TriggerEvent $trigger = null)
    {
        // Lazy load
    ...
    public function getValuesContexts($trigger)
    {
    ...
    public function getConditions($trigger)
    {
    ...
    abstract public function getConditionExtensions(Model_TriggerEvent $trigger);
    abstract public function renderConditionExtension($token, $as_token, $trigger, $params=array(), $seq=null);
    abstract public function runConditionExtension($token, $as_token, $trigger, $params, DevblocksDictionaryDelegate $dict);

    public function renderCondition($token, $trigger, $params=array(), $seq=null)
    {
    ...
    public function runCondition($token, $trigger, $params, DevblocksDictionaryDelegate $dict)
    {
    ...
    public function getActions($trigger)
    ...
    abstract public function getActionExtensions(Model_TriggerEvent $trigger);
    abstract public function renderActionExtension($token, $trigger, $params=array(), $seq=null);
    abstract public function runActionExtension($token, $trigger, $params, DevblocksDictionaryDelegate $dict);
    ...
    public function renderAction($token, $trigger, $params=array(), $seq=null)
    {
    ...
    public function simulateAction($token, $trigger, $params, DevblocksDictionaryDelegate $dict)
    {
        $actions = $this->getActionExtensions($trigger);
    ...
    public function runAction($token, $trigger, $params, DevblocksDictionaryDelegate $dict, $dry_run=false)
    {
        $actions = $this->getActionExtensions($trigger);
...
abstract class Extension_DevblocksEventCondition extends DevblocksExtension
{
    ...
    abstract public function render(Extension_DevblocksEvent $event, Model_TriggerEvent $trigger, $params=array(), $seq=null);
    abstract public function run($token, Model_TriggerEvent $trigger, $params, DevblocksDictionaryDelegate $dict);
};
...
abstract class Extension_DevblocksCacheEngine extends DevblocksExtension
{
    ...
    abstract public function testConfig(array $config);
    abstract public function renderConfig();
    abstract public function renderStatus();

    abstract public function isVolatile();
    abstract public function save($data, $key, $tags=array(), $lifetime=0);
...
abstract class Extension_DevblocksSearchSchema extends DevblocksExtension
{
    ...
    abstract public function query($query, $attributes=array(), $limit=250);
    abstract public function index($stop_time=null);
...
abstract class Extension_DevblocksStorageEngine extends DevblocksExtension
{
    ...
    abstract public function renderConfig(Model_DevblocksStorageProfile $profile);
    abstract public function saveConfig(Model_DevblocksStorageProfile $profile);
    abstract public function testConfig(Model_DevblocksStorageProfile $profile);

    abstract public function exists($namespace, $key);
    abstract public function put($namespace, $id, $data);
    abstract public function get($namespace, $key, &$fp=null);
    abstract public function delete($namespace, $key);
...
class DevblocksHttpRequest extends DevblocksHttpIO
{
     ...
     * @param array $path
     */
    public function __construct($path, $query=array(), $method=null)
    {
...
class DevblocksHttpResponse extends DevblocksHttpIO
{
     ...
     * @param array $path
     */
    public function __construct($path, $query=array())
    {
        parent::__construct($path, $query);
    }
};
...
class _DevblocksSortHelper
{
    ...
    public static function sortByNestedMember($a, $b)
    {
