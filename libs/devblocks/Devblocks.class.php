...
class DevblocksPlatform extends DevblocksEngine
{
    ...
    public static function installPluginZip($zip_filename)
    {
    ...
    public static function installPluginZipFromUrl($url)
    {
     ...
     */
    public static function importVar($value, $type=null, $default=null)
    {
    ...
    private static function _stripMagicQuotes(&$item, $key)
    {
        if (is_string($item)) {
     ...
     * @test DevblocksPlatformTest
     */
    public static function intClamp($n, $min, $max)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function floatClamp($n, $min, $max)
    {
    ...
    public static function curlExec($ch, $follow=false, $return=true)
    {
        // Proxy
     ...
     * @test DevblocksPlatformTest
     */
    public static function parseStringAsRegExp($string)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function parseBytesString($string)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function parseCrlfString($string, $keep_blanks=false, $trim_lines=true)
    {
        $string = str_replace("\r\n", "\n", $string);
        $parts = preg_split("/[\r\n]/", $string);
     ...
     * @test DevblocksPlatformTest
     */
    public static function parseAtMentionString($string)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function objectsToStrings($objects)
    {
        $strings = array();
     ...
     * @test DevblocksPlatformTest
     */
    public static function intVersionToStr($version, $sections=3)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function strVersionToInt($version, $sections=3)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function strToRegExp($arg, $is_partial=false)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function strAlphaNum($arg, $also=null, $replace="")
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function strUnidecode($string, $from_encoding = 'utf-8')
    {
        if (0 == strlen($string)) {
            return '';
        }
     ...
     * @test DevblocksPlatformTest
     */
    public static function strBase32Encode($str)
    {
        // RFC-4648
     ...
     * @test DevblocksPlatformTest
     */
    public static function strBase32Decode($str, $as_string=false)
    {
        // RFC-4648
        $alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
        $binary = '';
     ...
     * @test DevblocksPlatformTest
     */
    public static function stripHTML($str, $strip_whitespace=true, $skip_blockquotes=false)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function purifyHTML($dirty_html, $inline_css=false, $options=array())
    {
    ...
    public static function strEscapeHtml($string)
    {
        if (0 == strlen($string)) {
            return '';
        }
    ...
    public static function strToInitials($string)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function strToPermalink($string, $spaces_as='-')
    {
        if (0 == strlen($string)) {
            return '';
        }
     ...
     * @test DevblocksPlatformTest
     */
    public static function strToHyperlinks($string)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function strSecsToString($string, $length=0)
    {
    ...
    public static function strTimeToSecs($string)
    {
        if (empty($string)) {
            return 0;
        }
     ...
     * @test DevblocksPlatformTest
     */
    public static function strPrettyTime($string, $is_delta=false)
    {
        if (empty($string) || !is_numeric($string)) {
            return '';
        }
     ...
     * @test DevblocksPlatformTest
     */
    public static function strPrettyBytes($string, $precision='0')
    {
        if (!is_numeric($string)) {
            return '';
        }
     ...
     * @test DevblocksPlatformTest
     */
    public static function parseCsvString($string, $keep_blanks=false, $typecast=null)
    {
        if (0 == strlen($string)) {
            return array();
        }
     ...
     * @test DevblocksPlatformTest
     */
    public static function formatNumberAs($number, $as)
    {
        $label = $number;
     ...
     * @test DevblocksPlatformTest
     */
    public static function strFormatJson($json)
    {
        $result = '';
        $pos = 0;
        $strLen  = strlen($json);
     ...
     * @test DevblocksPlatformTest
     */
    public static function &jsonGetPointerFromPath(array &$array, $path)
    {
        if (empty($path)) {
            return false;
        }
     ...
     *
     */
    public static function clearCache($one_cache=null)
    {
    ...
    public static function getDatabaseTables($nocache=false)
    {
     ...
     * @return boolean
     */
    public static function versionConsistencyCheck()
    {
     ...
     * @return boolean
     */
    private static function _needsToPatch()
    {
     ...
     */
    public static function getExtensions($point, $as_instances=false, $ignore_acl=false)
    {
        $results = array();
     ...
     * @return DevblocksExtensionManifest
     */
    public static function getExtension($extension_id, $as_instance=false, $ignore_acl=false)
    {
        $result = null;
        $extensions = DevblocksPlatform::getExtensionRegistry($ignore_acl);
     ...
     * @return DevblocksExtensionManifest[]
     */
    public static function getExtensionRegistry($ignore_acl=false, $nocache=false, $with_disabled=false)
    {
        $cache = self::getCacheService();
    ...
    public static function getActivityPointRegistry()
    {
        $cache = self::getCacheService();
        $plugins = DevblocksPlatform::getPluginRegistry();
     ...
     */
    public static function getEventPointRegistry()
    {
        $cache = self::getCacheService();
     ...
     */
    public static function getAclRegistry()
    {
        $cache = self::getCacheService();
    ...
    public static function isPluginEnabled($plugin_id)
    {
    ...
    private static function _sortPluginsByDependency(&$plugins)
    {
        $dependencies = array();
        $seen = array();
        $order = array();
    ...
    private static function _recursiveDependency($id, $deps, &$seen, &$order, $level=0)
    {
        if (isset($seen[$id])) {
            return true;
        }
     ...
     * @return DevblocksPluginManifest[]
     */
    public static function readPlugins($is_update=true, $scan_dirs = array('features', 'plugins'))
    {
        $plugins = array();
     ...
     */
    public static function getPluginSettingsService()
    {
        return _DevblocksPluginSettingsManager::getInstance();
    }
    
    public static function getPluginSetting($plugin_id, $key, $default=null, $json_decode=false)
    {
        $settings = self::getPluginSettingsService();
        return $settings->get($plugin_id, $key, $default, $json_decode);
    }
    
    public static function setPluginSetting($plugin_id, $key, $value, $json_encode=false)
    {
        $settings = self::getPluginSettingsService();
     ...
     */
    public static function getConsoleLog($prefix='')
    {
     ...
     */
    public static function getNaturalLanguageService()
    {
     ...
     */
    public static function getNeuralNetwork($inputs, $hiddens, $outputs, $learning_rate)
    {
     ...
     */
    public static function getRegistryService()
    {
        return _DevblocksRegistryManager::getInstance();
    }
    
    public static function setRegistryKey($key, $value, $as=DevblocksRegistryEntry::TYPE_STRING, $persist=false)
    {
    ...
    public static function getRegistryKey($key, $as=DevblocksRegistryEntry::TYPE_STRING, $default=null)
    {
        $registry = self::getRegistryService();
     ...
     */
    public static function getClassLoaderService()
    {
     ...
     */
    public static function getOpenIDService()
    {
        return _DevblocksOpenIDManager::getInstance();
    }
    
    private static function _deepCloneArray(&$array)
    {
        if (is_array($array)) {
    ...
    public static function deepCloneArray($array)
    {
        $copy = $array;
    ...
    public static function extractArrayValues($array, $key, $only_unique=true)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function sanitizeArray($array, $type, $options=array())
    {
        if (!is_array($array)) {
            return array();
        }
     ...
     * @test DevblocksPlatformTest
     */
    public static function sortObjects(&$array, $on, $ascending=true)
    {
     ...
     * @return Smarty
     */
    public static function getTemplateSandboxService()
    {
     ...
     */
    public static function getTemplates($set=null)
    {
        $templates = array();
        $plugins = self::getPluginRegistry();
     ...
     */
    public static function getDateService($datestamp=null)
    {
     ...
     * @test DevblocksPlatformTest
     */
    public static function setDateTimeFormat($time_format)
    {
     ...
     */
    public static function setHttpRequest(DevblocksHttpRequest $request)
    {
     ...
     */
    public static function setHttpResponse(DevblocksHttpResponse $response)
    {
    ...
    public static function setExtensionDelegate($class)
    {
    ...
    public static function setHandlerSession($class)
    {
        if (!empty($class) && class_exists($class, true)) {
    ...
    public static function getHandlerSession()
    {
        return self::$handlerSession;
    }
    
    public static function redirect(DevblocksHttpIO $httpIO, $wait_secs=0)
    {
    ...
    public static function redirectURL($url, $wait_secs=0)
    {
        if (empty($url)) {
            $url_service = self::getUrlService();
    ...
    public static function dieWithHttpError($message, $status_code=500)
    {
    ...
    public static function markContextChanged($context, $context_ids)
    {
